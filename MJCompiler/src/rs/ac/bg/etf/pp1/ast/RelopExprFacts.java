...
public class RelopExprFacts extends CondFact {

    private ExprNonTern ExprNonTern;
    private Relop Relop;
    private ExprNonTern ExprNonTern1;

    public RelopExprFacts (ExprNonTern ExprNonTern, Relop Relop, ExprNonTern ExprNonTern1) {

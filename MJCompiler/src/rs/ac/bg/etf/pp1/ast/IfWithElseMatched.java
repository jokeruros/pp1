...
public class IfWithElseMatched extends Matched {
    ...
    public IfWithElseMatched (If If, CondOrErr CondOrErr, Matched Matched, Else Else, Matched Matched1) {
        this.If=If;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IfWithElseMatched(\n");
